            ...
            <div class="mx-4 sm:p-8">
                <form method="post" action="{{route('post.store')}}"  enctype="multipart/form-data">
                    ...
                    <div class="md:flex items-center mt-8">
                        ...
                        <input type="text" name="title" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="title" id="title" value="{{old('title')}}" placeholder="Enter Title">
                        </div>
                    </div>
