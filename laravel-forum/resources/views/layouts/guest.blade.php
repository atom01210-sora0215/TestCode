        ...
        <div class="font-sans text-gray-900 antialiased">
            <div class="w-full container mx-auto p-6">
                <div class="w-full flex items-center justify-between">
                    {{-- ロゴ追加--}}
                    <a href="{{route('top')}}"><img src="{{asset('logo/logo.png')}}" style="max-height:80px;"></a>
            ...
            {{-- <div class="w-full container mx-auto sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg"> --}}
            <div class="w-full container mx-auto p-6 items-center">
            {{ $slot }}
            </div>
        </div>
    </body>
